...
2. Expand the proven surface Forest/Desert/Jungle/Snow V0 and underground Forest V0 contracts across the remaining biome matrix one bounded composition at a time.

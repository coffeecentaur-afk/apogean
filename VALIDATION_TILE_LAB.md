...
The next renderer gate is one Wastes underground-depth set. It will establish the transition/top/ground/fill relationship before mushroom, desert, snow, jungle, evil, Hallow, Maw, and faction scenery expand from that contract.

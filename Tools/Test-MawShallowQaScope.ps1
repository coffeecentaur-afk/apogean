...
namespace apogean.Content.Diagnostics {
    public static class ShallowScopeChecks {
        public static int Run() {
            ...
            foreach(string request in new[]{"maw-shallow-build","maw-sketch-build","maw-sketch-unknown","maw-contour-build","maw-contour-unknown","maw-shallow-unknown","vegetation-view-build","qa-perf-start","kessler-campus",null})
            ...
            foreach(string request in new[]{"pristine","reload","entrance","ribs","cave","lower","light-on","light-off","capture","release"}) {
                Check(MawShallowQaScope.Request(MawShallowQaScope.Plain,"maw-sketch-"+request),"plain sketch visit allowed");
                Check(!MawShallowQaScope.Request("ordinary","maw-sketch-"+request),"ordinary sketch denied");
            }

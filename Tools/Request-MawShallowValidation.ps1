param([Parameter(Mandatory)][ValidateSet('build','test','pristine','audit','reload','top','bottom','pocket','rib1','rib2','rib3','play','motion-entry','light','capture','release')][string]$Case)

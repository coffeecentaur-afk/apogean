[CmdletBinding()]
param(
    [ValidateSet('Status', 'Tree', 'Terrain', 'MawMaterials', 'MawAnatomy', 'MawShallow', 'MawTeeth', 'Performance', 'Background', 'Entity', 'Structure', 'Boss', 'Quest', 'All')]
    [string]$Profile = 'All',
    [switch]$Build
)
...
$profiles = @{
    ...
    MawShallow = @('Tools/Test-MawShallowTraversalPlan.ps1', 'Tools/Test-MawShallowMotionTrace.ps1')

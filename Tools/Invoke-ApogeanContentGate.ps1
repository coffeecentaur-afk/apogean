...
$profiles = @{
    ...
    Terrain = @('Tools/Test-WastesTerrainAtlases.ps1', 'Tools/Test-MawStructuralWall.ps1', 'Tools/Test-RigidPlantAtlas.ps1', 'Tools/Test-ReportedVisualRegressions.ps1', 'Tools/Test-SurfaceRegression.ps1')

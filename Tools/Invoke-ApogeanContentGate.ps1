...
$profiles = @{
    ...
    Terrain = @('Tools/Test-ReportedVisualRegressions.ps1', 'Tools/Test-SurfaceRegression.ps1')
    Background = @('Tools/Test-BackgroundHdContracts.ps1', 'Tools/Test-BackgroundProductionReadiness.ps1')

...
$profiles.MawShallow += 'Tools/Test-MawRopeItemUsePlan.ps1'
$profiles.MawShallow += 'Tools/Test-MawRopeItemUseEvidence.ps1'
$profiles.MawShallow += 'Tools/Test-MawItemPreview.ps1'
$profiles.MawShallow += 'Tools/Test-MawItemPreviewEvidence.ps1'

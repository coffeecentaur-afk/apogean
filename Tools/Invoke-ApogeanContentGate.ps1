...
$profiles = @{
    ...
    Background = @('Tools/Test-MaskedBackgroundExport.ps1', 'Tools/Test-WastesCityMask.ps1', 'Tools/Test-ForestRestoration.ps1', 'Tools/Test-BackgroundHdContracts.ps1', 'Tools/Test-BackgroundProductionReadiness.ps1')

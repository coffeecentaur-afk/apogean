...
$profiles = @{
    ...
    Structure = @('Tools/Test-ArrivalPodNativePipeline.ps1', 'Tools/Test-ArrivalPodFooting.ps1', 'Tools/Test-ArrivalPodLiveValidator.ps1', 'Tools/Test-HelixConstructionSet.ps1', 'Tools/Test-WorldVisualIntegrity.ps1')

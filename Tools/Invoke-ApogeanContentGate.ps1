[CmdletBinding()]
param(
    [ValidateSet('Status', 'Tree', 'Terrain', 'MawMaterials', 'MawAnatomy', 'MawShallow', 'MawTeeth', 'MawCave', 'Performance', 'Background', 'Entity', 'Structure', 'Boss', 'Quest', 'All')]
    [string]$Profile = 'All',
    [switch]$Build
)
...
$selectedProfiles = if ($Profile -eq 'All') { @('Status', 'Tree', 'Terrain', 'MawMaterials', 'MawAnatomy', 'MawShallow', 'MawTeeth', 'MawCave', 'Performance', 'Background', 'Entity', 'Structure', 'Boss', 'Quest') } else { @($Profile) }

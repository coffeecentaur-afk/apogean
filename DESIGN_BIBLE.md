...
- The world planner solves critical landmarks together, registers their envelopes before cooperating detail and structure passes, and uses bounded rerouting rather than deleting intersecting structures after generation.
...
- The Burning Root contains a roughly 180–240 by 90–130 tile natural Matriarch cavity. It has no generated platforms or mandatory repair objective; players clear and build it like a large evil-biome boss space.
...
- Its early reservation owns only the authored route, shell, chambers, and basin envelopes. It consumes natural terrain inside that plan, reroutes around protected or foreign structures, and never treats player structures, chests, housing, or protected sites as disposable conversion targets.

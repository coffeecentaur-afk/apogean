...
- Latest entrance direction: substantially taller raised "lips"/rim ridges and a dense abundance of teeth around the crown and down the throat, with the Sarlacc pit as a composition reference. Keep original Maw anatomy/materials and the two asymmetrical side basins; no copied creature, beak or additional mechanics. The current preview proposes51 tooth groups and rim crests24/22 tiles above local ground, not accepted release dimensions. No safe ledges; rope or breaking teeth remains the intended player solution.

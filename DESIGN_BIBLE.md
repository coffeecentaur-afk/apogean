...
- Pod art clarification: preserve the seat, hinged open hatch, heat shield and unbranded shell through deliberate pixel clusters. A3's native appearance was initially accepted, then rejected as too detailed after live testing. The user accepts A4's coarser style and requests more grit, broken plating and a convincing impact landing area. Use broad soot/mud patches, large chipped edges and exposed framing instead of tiny speckles or intricate panel lines. A5 impact concept is review-only; native fitting and renewed visual proof precede replacement. Keep the movable pod separate from shallow compressed terrain and scattered debris. Do not turn the spawn divot into a large crater or obstacle.

...
## Approved behavior, not pending questions

The user selected immediate normal-pickaxe recovery; moving the pod never moves
world/bed spawn. Relay repair is later. This design does not introduce shops,
storage, weapons, communications functionality or faction branding.
...
The installed package remained SHA256
`FE1B5E8B284FE8A21CF3029964967997396D8226F32F1A9D5E0F0642655669FA`.
No runtime C#, Content asset, save schema or generation pass changed in this
design turn. Authoring-status consistency passed for 37 families; that is a
documentation/status check, not a pod build or live proof.

...
This is **fixture-pass**, not integrated or polished. The later [extended grove checks](Extended/README.md) add strong-wind samples in both directions, a dark new-moon sample, native trunk/root/top paint, wood-drop and whole-prop break assertions, and confirmed QA save/quit. The [persistence and growth follow-up](Persistence/README.md) verifies painted side branches, flat/terrace/blocked/sloped/close-neighbor growth cases and an unchanged saved-grove digest after reload without rebuilding. Full-moon bark readability remains partial. Actual axe/shake/Acorn input, elapsed-time natural growth, multiplayer observation and fresh-world distribution remain open. Accelerated RandomUpdate/GrowTree/KillTile proof must not be described as manual planting or axe-input coverage.

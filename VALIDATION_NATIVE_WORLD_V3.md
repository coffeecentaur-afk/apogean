...
The automatic `Apogee Native Visual V3` fixture additionally fixes the world at midday, grows four native ruined trees, performs a deterministic mid-trunk chop on the fourth tree, and fails immediately unless the canopy is removed while the stump remains. Its capture-camera probe resolves Apogean's post-arbitration global background slot explicitly, so the panorama and ordinary camera must show the same ruined Forest composition.

The surface-background fixture is biome-selectable and currently validates Forest V0, Desert V0, Jungle V0, Snow V0, Corruption V0, Crimson V0, Hallow V0, Ocean V0, and Mushroom V0. It clears a low, wall-free Wastes stage, fixes the world at midday for repeatable palette review, and renders the same production layer files used in ordinary play. Desert V0 passed a 2560×1400 gameplay-viewport check with readable far/middle/close separation, no rectangular transparency holes, and no hard vertical repeat seam. Jungle V0 passed the same check with the distant canopy/lab skyline, overgrown dome-and-transit complex, and close vegetation banks remaining distinct at runtime parallax scales. Snow V0 passed after its initial flat lower fill was replaced with an irregular snow-and-icicle shelf; frozen mountains, broken turbines, domes, and antenna towers now remain readable without a rectangular horizon gap. Corruption V0 passed with its distant refinery-and-dome skyline, broken bridge between infected industrial ruins, and close thorn/root rim remaining distinct while preserving a broad combat lane; violet accents remain controlled and the authored dark tower reads independently of the repeat boundaries. Crimson V0 passed on its second live render after the far skyline's generic edge taper was removed: its red city and hanging megastructure now repeat continuously behind biomass-swallowed medical towers and a low hooked-organic foreground while keeping the central combat view open. Hallow V0 passed on its second live render after the same generic edge treatment was removed rather than allowed to create dark diagonal slabs: its pale orbital skyline, ruined radio-astronomy campus, luminous crystal growth, and close dish wreckage now remain legible as separate parallax depths while the center stays open for combat. Ocean V0 passed on its third live render after the middle and close layers were raised with clipped negative offsets: its drowned harbor skyline, failed evacuation wrecks, cranes, shattered pilings, and barnacled machinery now occupy the gameplay horizon rather than disappearing below it, while keeping the player readable against the port. Mushroom V0 passed on its third live render: the first pass exposed flat top-edge crops in the generated mid and close extractions, the second proved the corrected transparent headroom but revealed one isolated opaque extraction speck, and the accepted pass uses complete curved silhouettes plus deterministic removal of disconnected 1–6-pixel debris. Its cobalt fungal skyline, ruined conservatories, nutrient gantry, treatment tanks, pipes, and cyan/lavender growth remain distinct across all three depths while preserving the central lane. Approved evidence is retained at `Art/Validation/2026-09-03-DesertV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-JungleV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-SnowV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-CorruptionV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-CrimsonV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-HallowV0SurfaceBackgroundRenderLab.jpg`, `Art/Validation/2026-09-03-OceanV0SurfaceBackgroundRenderLab.jpg`, and `Art/Validation/2026-09-03-MushroomV0SurfaceBackgroundRenderLab.jpg`.

...
| --- | --- | --- |
| Wastes / ordinary forest history | Kessler military-industrial | Dead roadside frontier. Far: subdued ruined industrial city. Mid: low service buildings, checkpoint and broken shell, existing Station/Highway. Close: longer broken-earth banks and dead vegetation. Recovery keeps these same ruins and adds living turf, vines, shrubs and trees. Close leads, Mid follows, Far trails with overlapping growth. Far shows world-wide progress as increasingly dense plants scattered throughout the city even early on, never a spatial wipe or last-minute swap. Native Forest is only the installed technical fallback. Counting/curves and implementation remain open; see WASTES_RECLAMATION_DIRECTION.md. |

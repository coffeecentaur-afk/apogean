...
namespace apogean.Content.Tiles
{
	...
	public sealed class DeadForestSapling : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ItemID.Acorn);
			AddMapEntry(new Color(92, 68, 42), Language.GetText("MapObject.Sapling"));
		}
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			bool grew = WorldGen.GrowTree(i, j);
			if (grew && WorldGen.PlayerLOS(i, j))
			{
